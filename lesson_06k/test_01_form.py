...
def form_compl():
    ...
    assert first_name.find("alert-success") != -1
    assert last_name.find("alert-success") != -1
    assert Address.find("alert-success") != -1
    assert Zip_code.find("alert-danger") != -1
    assert City.find("alert-success") != -1
    assert Country.find("alert-success") != -1
    assert Email.find("alert-success") != -1
    assert Phone_number.find("alert-success") != -1
    assert Job_position.find("alert-success") != -1
    assert Company.find("alert-success") != -1
